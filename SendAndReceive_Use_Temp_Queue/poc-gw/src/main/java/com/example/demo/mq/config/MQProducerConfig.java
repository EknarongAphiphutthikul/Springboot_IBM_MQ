...
public class MQProducerConfig {
	...
	@Bean
	public WrapperJmsTemplate jmsTemplate(CachingConnectionFactory connectionFactory, JedisManager jedisManager) {
		int timeout = 10000;
		WrapperJmsTemplate jmsTemplate = new WrapperJmsTemplate(connectionFactory, jedisManager, timeout + 500);
