...
public class MQConsumerConfig {
	...
	public JmsMessageEndpointManager createJmsMessageEndpointManager(ResourceAdapterImpl resourceAdapter,
			ActivationSpecImpl activationSpec, MQConfigProperties config) throws Exception {
		...
		jmsMessageEndpointManager.setMessageListener(new ExampleListener(jmsTemplate, config.getQueueDestinationOutput(), maxTimeDelay));
